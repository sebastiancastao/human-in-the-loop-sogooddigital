...
export function ChatBubbleIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75a9.723 9.723 0 01-5.036-1.397L2.25 21.75l1.147-4.863A9.695 9.695 0 012.25 12z" />
    </svg>
  );
}
...
export function ContextIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
    ...
    >
      <path
        ...
        d="M11.25 11.25h1.5v5.25h-1.5v-5.25zM12 8.25h.008v.008H12V8.25z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
